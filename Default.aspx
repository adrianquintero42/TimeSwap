<%@ Page Title="Time Swap" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="TimeSwap._Default" %>
        ...
        <div id="containerLoginRow" class="row containerRow">
            ...
            <fieldset id="containerLoginForm" class="col-lg-6 col-md-6 col-sm-12 containerForm">
                <div>
                    ...
                    <div class="form-row">
                        <div class="col-lg-3"></div>
                        <div class="form-check col-lg-6 termsCheck">
                            <asp:CheckBox type="checkbox" CssClass="form-check-input" ID="inputTermsLogin" runat="server" />
                            <label for="inputTermsLogin" class="form-check-label">Recordarme</label>
                        </div>
                        <div class="col-lg-3"></div>
                    </div>
